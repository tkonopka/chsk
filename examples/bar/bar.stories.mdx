...
import { generateDotBarData, DotBarChart } from './DotBarChart'
    ...
    <Story name="grouped, horizontal">
        <Controller
            ...
            comment={
                <div>
                    <p>
                        This example is non-interactive. (The legends are not clickable. There is no
                        tooltip).
                    </p>
                    <p>Instead, it shows customized calculations for each band.</p>
                </div>
            }
        />
    </Story>
...
<Canvas>
    <Story name="dots">
        <Controller generator={generateDotBarData} chart={DotBarChart} steps={['axes', 'data']} />
    </Story>
</Canvas>
