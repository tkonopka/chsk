...
In both cases, the container props always have the same format and carry the same meaning.
...
Values can be specified in absolute svg units, as fractions of a parent container,
