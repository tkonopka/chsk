...
By setting styles globally and not for individual components, themes make code less verbose.
Themes also help in preparing multiple charts with a consistent appearance.

<div className="sidenote">
    **Side note**: This page describes the theme syntax with a minimal example. For additional
    information, including about ready-made themes, see the [themes
    addon](/?path=/docs/addons-themes-overview--page).
</div>
