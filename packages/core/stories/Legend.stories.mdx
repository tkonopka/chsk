...
import { Legend, Rectangle, Surface } from '../src'
import { ChartForLegendDecorator, ChartForLegend2Decorator } from './decorators'
...
<Canvas>
    <Story
        name="automatic content, vertical"
        args={{
            position: [240, 0],
            size: [60, 80],
            units: 'absolute',
    ...
    <Story
        name="automatic content, horizontal 1"
        args={{
            position: [0, 0],
            size: [240, 70],
            units: 'absolute',
    ...
    <Story
        name="automatic content, horizontal 2"
        args={{
            position: [0, 140],
            size: [240, 60],
            units: 'absolute',
