...
Note: examples on this page involve multiple components, including external buttons. For this reason, the code is more than a few lines long; the complete source code is available in the [source repository](https://github.com/tkonopka/chask/blob/main/packages/core/stories/components/Milestone.animations.tsx).
