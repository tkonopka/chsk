...
The prop `position` marks a location on the chart / view. This can be specified with absolute values `[x, y]`, or as fractions of the chart / view dimensions together with a prop `positionRelative`.
