...
All components can be customized using inline styles. Visual styles are also adjustable via global themes. It is thus possible to quickly change the look-and-feel of charts by applying a different theme, and to create multiple charts with a consistent appearance.

### Interactivity

Chart components can handle mouse events and animate changes in underlying data.
