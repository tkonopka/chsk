...
import * as DistributionStories from './Distribution.stories'
...
<ArgTypes of={DistributionStories} />
...
<Canvas of={DistributionStories.Vertical} />
<Canvas of={DistributionStories.Horizontal} />

## Other features

`Distribution` supports many of the same features as `Bar`, for example, for adjusting padding.
