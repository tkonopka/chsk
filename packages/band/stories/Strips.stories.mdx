...
`Strips` is intended to be used within a `Strip` component. Note that while the `Strips` component is the one that draws data points, much of the chart layout is determined by the parent view `Strip`.
