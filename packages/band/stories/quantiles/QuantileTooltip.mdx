...
import * as QuantileTooltipStories from './QuantileTooltip.stories'

# QuantileTooltip

<Meta of={QuantileTooltipStories} />

`QuantileTooltip` creates a tooltip summarizing a distribution.

<ArgTypes of={QuantileTooltipStories} />
...
<Canvas of={QuantileTooltipStories.Tooltip} />
...
<Canvas of={QuantileTooltipStories.TableFormat} />
